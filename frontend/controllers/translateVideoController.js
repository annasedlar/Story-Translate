app.controller('translateVideoController',['$scope', '$location', '$http', '$sce', function($scope, $location, $http, $sce){
	...
	var onLoadUrl = 'http://annasedlar.com:3003/transcript/' + paramsId
	$http({
    	method: "GET",
    	url: onLoadUrl
  	}).then(
	...
	var tempUrl = 'http://annasedlar.com:3003/videos'
	$http({
    	method: "GET",
    	url: tempUrl
  	}).then(
	...
	$scope.changeFamilyName = function(){
		...
		var tempDataToSend = {
  	    ...
  	    $http({
			method:'POST',
      		url: 'http://annasedlar.com:3003/changeFamilyName/',
      		data: tempDataToSend
    	}).then(
	...
	$scope.saveForm = function(){
		var transcriptUrl = 'http://annasedlar.com:3003/transcript/' + $location.$$path.slice(16)
		$http({
			method:'POST',
      		url: transcriptUrl,
	...
	$scope.submitForm = function(){
		...
		$http({
			method:'POST',
      		...
      		function successFunction(data){			
				var finishedUrl = 'http://annasedlar.com:3003/finished/' + $location.$$path.slice(16);
