app.controller('uploadRawVideoController',function($scope, $location, $http){
	...
	$scope.submit = function(){
		...
		$http.post('http://annasedlar.com:3003/videos', formData, {
		...
		// $http.post('http://annasedlar.com:3003/thumbnails', $scope.tempImage, {
		// 	transformRequest: angular.identity,
		// 	headers:{
		// 		'Content-Type' : undefined
		// 	}
  ...
  //   	$http({
  //   		method:"POST",
  //   		url: 'http://annasedlar.com:3003/thumbnails',
